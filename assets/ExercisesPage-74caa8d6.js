import{a as h,k as X,s as l,u as A,d as W,j as e,b as E,D as Y,E as J,F as Q,t as d,B as I,G as q,n as D,H as Z}from"./index-8e970006.js";import{M as ee,a as te,W as re,S as ie,T as ne,C as se,b as oe,V as ae,c as le,d as ce,B as de,e as he,f as pe,g as xe,N as ue,I as me,h as ge,i as fe,j as M,k as be,l as we,m as je,n as ye}from"./AddExerciseSuccess.styled-e9863f2f.js";import{a as V}from"./ReusableStyles.styled-b6573a2a.js";function ke(t){const[r,i]=h.useState([]);return h.useEffect(()=>{(async()=>{try{const n=await X.get(`http://localhost:3333/api/exercises/filters?filter=${t}`);i(n.data)}catch(n){console.error("Error fetching categories:",n)}})()},[t]),r}const ve=l.div`
  max-width: 335px;
  margin-left: auto;
  margin-right: auto;
