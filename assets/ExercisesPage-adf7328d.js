import{a as h,m as X,s as l,u as A,d as W,j as e,b as E,A as Q,C as Y,D as J,t as d,y as I,Q as Z,E as q,B as D,F as ee}from"./index-2c988186.js";import{M as te,a as ie,W as re,S as ne,T as se,C as oe,b as ae,V as le,c as ce,d as de,B as he,e as pe,f as xe,g as ue,N as me,I as ge,h as fe,i as be,j as M,k as we,l as je,m as ye,n as ke}from"./AddExerciseSuccess.styled-4f794a15.js";import{a as V}from"./ReusableStyles.styled-097c6e31.js";function ve(t){const[i,r]=h.useState([]);return h.useEffect(()=>{(async()=>{try{const n=await X.get(`http://localhost:3333/api/exercises/filters?filter=${t}`);r(n.data)}catch(n){console.error("Error fetching categories:",n)}})()},[t]),i}const Ce=l.div`
  max-width: 335px;
  margin-left: auto;
  margin-right: auto;
