import{s as i,t as a,j as e,b as g,u as k,d as b,e as _,a as u,f as $,B as c,g as z,h as S,Q as U,i as L,k as A,m as E,o as R}from"./index-c4c0e754.js";import{c as C,a as D,e as x,f as O,u as q,d as N,F as I,b as T}from"./formik.esm-0b5edfe2.js";import{i as B}from"./index-09c485a4.js";import{W as M}from"./WelcomePage.styled-58b43c48.js";const P=i.div`
  display: flex;
...
align-items: center;
gap:8px;
`,W=({svg:n,text:t,number:d,min:l})=>{const s=l?`${d} min`:d;return e.jsxs(P,{children:[e.jsxs(H,{children:[e.jsx("svg",{width:20,height:20,children:e.jsx("use",{href:`${g}#${n}`})}),e.jsx(V,{children:t})]}),e.jsx(Y,{children:s})]})},J=i.div`
    width: 100%;
    margin-top: 32px;
    display: flex;
    gap: 14px;
...
`,w=({id:n,value:t,name:d,label:l,onChange:s,checked:o})=>e.jsxs(je,{children:[e.jsx(we,{id:n,type:"radio",name:d,value:t,checked:o,onChange:s}),l]}),$e=({label:n,name:t})=>e.jsxs("div",{children:[e.jsx(m,{children:n}),e.jsx(j,{type:"number",name:t}),e.jsx(p,{name:t})]}),De=S`
...
`;const Fe=i.input`
  ...
  line-height: 129%;
  color: ${a.color.white};
`,Ie="/ui-power-pulse/assets/sprait-112b8185.svg",ze=({number:n})=>e.jsxs(e.Fragment,{children:[e.jsx(We,{width:"18",height:"18",children:e.jsx("use",{href:`${Ie}#icon-calendar`})}),e.jsx(B,{showYearDropdown:!0,scrollableYearDropdown:!0,maxDate:new Date,value:n,customInput:e.jsx(Fe,{}),dateFormat:"dd.MM.yyyy",calendarStartDay:1,formatWeekDay:t=>t.substring(0,1),showMonthDropdown:!0}),e.jsx(De,{})]}),Se=()=>{var s;const n=k(),t=b(_),d={name:t.name||"Name",email:t.email,height:t.bodyData&&t.bodyData.height||150,currentWeight:t.bodyData&&t.bodyData.currentWeight||35,desiredWeight:t.bodyData&&t.bodyData.desiredWeight||35,birthday:"2006-01-02",blood:t.bodyData.blood||1,sex:t.bodyData.sex||"male",levelActivity:parseInt((s=t.bodyData)==null?void 0:s.levelActivity,10)||1},l=async o=>{if(t.bodyData){if(JSON.stringify(o)===JSON.stringify(d)){c.error("Nothing to change");return}try{const{_id:r,...f}=t,h={_id:r,...o,blood:parseInt(o.blood,10)};n(L({_id:r,...f.bodyData,...h}))}catch(r){c.error("Error updating user data:",r)}}else c.warning("User bodyData is missing or not fully populated. Form not submitted.")};return e.jsx(T,{initialValues:d,validationSchema:ge,onSubmit:l,children:o=>e.jsxs(be,{children:[e.jsxs(fe,{children:[e.jsxs("div",{children:[e.jsx(m,{children:"Name"}),e.jsx(j,{type:"text",name:"name"}),e.jsx(p,{name:"name"})]}),e.jsxs("div",{children:[e.jsx(m,{children:"Email"}),e.jsx(j,{type:"email",name:"email",disabled:!0}),e.jsx(p,{name:"email"})]})]}),e.jsxs(ye,{children:[me.map(r=>e.jsx($e,{id:r.id,name:r.name,label:r.label},r.id)),e.jsxs("div",{children:[e.jsx(m,{children:"Day of Birth"}),e.jsxs("div",{style:{position:"relative"},children:[" ",e.jsx(ze,{number:d.birthday})]})]})]}),e.jsxs(ve,{children:[e.jsxs("div",{children:[e.jsx(m,{children:"Blood"}),e.jsx(F,{children:pe.map(r=>e.jsx(w,{id:r.id,name:"blood",label:r.label,onChange:()=>o.setFieldValue("blood",r.id),checked:o.values.blood==r.id},r.id))}),e.jsx(p,{name:"blood"})]}),e.jsxs(F,{children:[he.map(r=>e.jsx(w,{id:r.id,name:"sex",value:r.value,label:r.label},r.id)),e.jsx(p,{name:"sex"})]})]}),e.jsxs(ke,{children:[xe.map(r=>e.jsx(w,{id:r.id,name:"levelActivity",label:r.label,onChange:()=>o.setFieldValue("levelActivity",r.value),checked:o.values.levelActivity===r.value},r.id)),e.jsx(p,{name:"levelActivity"})]}),e.jsx(_e,{type:"submit",disabled:!o.dirty,children:"Save"}),e.jsx(U,{})]})})},Ue=i.div`
    @media screen and (min-width:${a.breakpoint.xl}){
        display:flex;
