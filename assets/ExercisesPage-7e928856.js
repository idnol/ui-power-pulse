import{a as h,k as X,s as l,u as A,d as W,j as e,b as E,D as Y,E as J,F as Q,t as c,B as I,G as q,n as D,H as Z}from"./index-0691a1d7.js";import{M as ee,a as te,W as ie,S as re,T as ne,C as se,b as oe,V as ae,c as le,d as ce,B as de,e as he,f as pe,g as xe,N as ue,I as me,h as ge,i as fe,j as M,k as we,l as be,m as je,n as ye}from"./AddExerciseSuccess.styled-9b2fe591.js";import{a as V}from"./ReusableStyles.styled-6cdf69b2.js";function ke(t){const[i,r]=h.useState([]);return h.useEffect(()=>{(async()=>{try{const n=await X.get(`http://localhost:3333/api/exercises/filters?filter=${t}`);r(n.data)}catch(n){console.error("Error fetching categories:",n)}})()},[t]),i}const ve=l.div`
  max-width: 335px;
  margin-left: auto;
  margin-right: auto;
