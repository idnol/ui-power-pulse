import{b as c,p as ee,s as d,t as i,u as P,d as J,j as e,a as E,E as te,F as re,G as ie,x as T,H as q,g as Y,J as ne}from"./index-59d1c4fa.js";import{M as oe,a as se,W as ae,S as le,T as de,C as ce,b as pe,V as he,c as xe,d as ue,B as me,e as ge,f as fe,g as be,N as we,I as ke,h as je,i as ve,j as $,k as ye,l as Se,m as Ce,n as Ae}from"./AddExerciseSuccess.styled-23ed8bfb.js";import{a as Z}from"./ReusableStyles.styled-4fcf5481.js";function Be(t){const[r,n]=c.useState([]);return c.useEffect(()=>{(async()=>{try{const a=await ee.get(`/exercises/filters?filter=${t}`);n(a.data)}catch(a){console.error("Error fetching categories:",a)}})()},[t]),r}const Ee=d.div`
position: relative;
`,Fe=d.div`
  max-width: 335px;
  margin-right: auto;
...
`,Ke=d.h4`
    ...
    margin: 2px 0 0;
    color: ${i.color.greyFifth};
`;function ze({subcategory:t}){const r=P(),n=()=>{r(re(t.name))};return e.jsx(Je,{onClick:n,children:e.jsxs(Ie,{children:[e.jsx(qe,{src:t.imgURL,alt:t.name}),e.jsxs(Ye,{children:[e.jsx(We,{children:t.name}),e.jsx(Ke,{children:t.filter})]})]})})}const De=d.div`
  display: flex;
