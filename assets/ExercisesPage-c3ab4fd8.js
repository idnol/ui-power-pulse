import{a as h,k as X,s as l,u as A,d as W,j as e,b as E,B as Y,C as J,D as Q,t as d,z as I,E as q,n as D,F as Z}from"./index-e029ae4d.js";import{M as ee,a as te,W as re,S as ie,T as ne,C as se,b as oe,V as ae,c as le,d as ce,B as de,e as he,f as pe,g as xe,N as ue,I as me,h as ge,i as fe,j as M,k as be,l as we,m as je,n as ye}from"./AddExerciseSuccess.styled-9659c89a.js";import{a as V}from"./ReusableStyles.styled-889b3230.js";function ke(t){const[r,i]=h.useState([]);return h.useEffect(()=>{(async()=>{try{const n=await X.get(`http://localhost:3333/api/exercises/filters?filter=${t}`);i(n.data)}catch(n){console.error("Error fetching categories:",n)}})()},[t]),r}const ve=l.div`
  max-width: 335px;
  margin-left: auto;
  margin-right: auto;
