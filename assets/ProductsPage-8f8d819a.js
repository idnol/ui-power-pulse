import{s as t,t as e,j as o,b,a as l,A as T,B,L as D,C as N,u as I,D as F,d as k,E as P,o as M}from"./index-eeffdabc.js";import{B as z,Q as W}from"./react-toastify.esm-aee47797.js";const V=t.div`
  padding-top: 40px;
  padding-bottom: 40px;
...
`,He=({onClose:i,title:n,calories:s,id:x})=>{const[a,r]=l.useState(""),[c,d]=l.useState("0"),[h,g]=l.useState(s),[p,m]=l.useState(!1),$=I(),y=w=>{const f=w.currentTarget.value;r(f);const O=Math.round(f*h/100);d(O)},j=async w=>{w.preventDefault();try{const f={product:x,weight:+a},u=await $(F(f));F.fulfilled.match(u)?(r(""),m(!0)):(m(!1),d("0"),z.error("Oops, something went wrong"))}catch{m(!1),d("0"),z.error("Oops, something went wrong")}},v=()=>{i(),m(!1)};return o.jsxs(o.Fragment,{children:[o.jsx(Ie,{onClick:i,children:o.jsx(Ee,{children:o.jsx(Le,{href:`${b}#x-modal`})})}),!p&&o.jsx(Be,{children:o.jsxs("form",{onSubmit:j,children:[o.jsxs(Ae,{children:[o.jsx(Oe,{children:o.jsx(Te,{children:n})}),o.jsxs(De,{children:[o.jsx(Me,{name:"number",required:!0,value:a,onChange:y}),o.jsx(Ne,{children:"grams"})]})]}),o.jsxs(We,{children:[o.jsx(Ye,{children:"Calories:"}),o.jsx(Ve,{children:c})]}),o.jsxs(qe,{children:[o.jsx(Ge,{type:"submit",children:"Add to diary"}),o.jsx(Qe,{type:"button",onClick:i,children:"Cancel"})]})]})}),p&&o.jsx(Re,{calories:c,isOpen:p,onClose:()=>v()}),o.jsx(W,{position:"bottom-right",limit:2,autoClose:3e3})]})},Ke=t.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100vw;
