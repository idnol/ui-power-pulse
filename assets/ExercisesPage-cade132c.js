import{a as d,p as Z,s as c,t as r,u as R,d as W,j as e,b as T,E as ee,F as te,G as ie,x as I,H as q,g as D,J as re}from"./index-e019d93f.js";import{M as ne,a as oe,W as se,S as ae,T as le,C as ce,b as de,V as pe,c as he,d as xe,B as me,e as ue,f as ge,g as fe,N as be,I as we,h as ke,i as je,j as A,k as $e,l as ye,m as ve,n as Se}from"./AddExerciseSuccess.styled-d6103b07.js";import{a as H}from"./ReusableStyles.styled-52177ea3.js";function Ce(t){const[i,n]=d.useState([]);return d.useEffect(()=>{(async()=>{try{const a=await Z.get(`http://localhost:3333/api/exercises/filters?filter=${t}`);n(a.data)}catch(a){console.error("Error fetching categories:",a)}})()},[t]),i}const Ee=c.div`
