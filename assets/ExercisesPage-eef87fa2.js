import{b as c,o as ee,s as d,t as i,u as P,d as J,j as e,a as E,D as te,E as re,F as ie,x as T,G as q,f as Y,H as ne}from"./index-b81f81fd.js";import{M as oe,a as se,W as ae,S as le,T as de,C as ce,b as pe,V as he,c as xe,d as ue,B as me,e as ge,f as fe,g as be,N as we,I as ke,h as je,i as ve,j as $,k as ye,l as Se,m as Ce,n as Ae}from"./AddExerciseSuccess.styled-aeb034c8.js";import{a as Z}from"./ReusableStyles.styled-727544c9.js";function Be(t){const[r,n]=c.useState([]);return c.useEffect(()=>{(async()=>{try{const a=await ee.get(`/exercises/filters?filter=${t}`);n(a.data)}catch(a){console.error("Error fetching categories:",a)}})()},[t]),r}const Ee=d.div`
position: relative;
`,Fe=d.div`
  max-width: 335px;
  margin-right: auto;
